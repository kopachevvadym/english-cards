...
interface AddWordDialogProps {
  open: boolean
  onClose: () => void
  onAddWord: (word: string, translation: string, examples: Example[]) => void
}
...
export const AddWordDialog = ({ open, onClose, onAddWord }: AddWordDialogProps) => {
  ...
  const handleAdd = () => {
    ...
    onAddWord(word.trim(), translation.trim(), validExamples)
    setWord('')
    setTranslation('')
    setExamples([])
    setError('')
      ...
      <DialogContent>
        <Box sx={{ pt: 1 }}>
          <Typography variant="body2" color="text.secondary" gutterBottom>
            Add a word with its translation and multiple examples.
          </Typography>
          ...
          <Box sx={{ p: 2, bgcolor: 'grey.50', borderRadius: 1 }}>
            ...
            <Typography variant="body2" color="text.secondary">
              Add multiple examples to provide better context for learning. Examples with both text and translation will be saved.
            </Typography>
          </Box>
        </Box>
      </DialogContent>
